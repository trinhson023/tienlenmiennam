...
[Migration("20260922100000_AddMatchCompletedOutbox")]
public sealed class AddMatchCompletedOutbox : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateIndex(
            name: "IX_integration_outbox_MatchId",
            schema: "samloc",
        ...
        migrationBuilder.CreateIndex(
            name: "IX_integration_outbox_PublishedAtUtc_CreatedAtUtc",
            schema: "samloc",
            table: "integration_outbox",
    ...
    protected override void Down(MigrationBuilder migrationBuilder) =>
        migrationBuilder.DropTable(name: "integration_outbox", schema: "samloc");
}
