...
public sealed record MatchStateView(Guid MatchId, Guid RoomId, long Version, string Status, Guid? CurrentPlayerUserId, bool CurrentPlayerIsBot, DateTimeOffset? TurnDeadlineUtc, bool IsOpeningPlay, string? CenterType, IReadOnlyList<string> Center, IReadOnlyList<string> Hand, IReadOnlyList<MatchPlayerView> Players, IReadOnlyList<Guid> WinnerOrder);
