...
public static class LobbyEndpoints
{
    ...
    private static IResult Map<T>(ServiceResult<T> result)
    {
        ...
        var status = result.ErrorCode switch {
            "room_not_found" or "game_not_found" or "bot_not_found" or "rematch_match_not_found" => StatusCodes.Status404NotFound,
            "host_only" or "game_not_enabled" or "not_in_room" => StatusCodes.Status403Forbidden,
            "already_in_room" or "room_full" or "room_not_open" or "join_conflict" or "bot_conflict" or "not_enough_players" or "match_in_progress" or "rematch_not_available" or "rematch_not_ready" or "rematch_roster_changed" or "rematch_room_mismatch" => StatusCodes.Status409Conflict,
